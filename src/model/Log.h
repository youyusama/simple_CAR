  ...
  public:
    ...
    void PrintStatistics() {
        ...
        if (m_settings.internalSignals) {
            m_log << "Internal Signals Time:\t" << m_internalSignalTime << std::endl;
        }
        if (m_settings.stat) {
    ...
    void StatInternalSignal() {
        m_internalSignalTime += static_cast<double>(clock() - m_tick) / CLOCKS_PER_SEC;
    }
