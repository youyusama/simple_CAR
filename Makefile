...
OBJS = CarSolver.o CarSolver_cadical.o BackwardChecker.o ForwardChecker.o CleanCARCheckerF.o AigerModel.o State.o main.o aiger.o MainSolver.o InvSolver.o OverSequence.o Log.o Vis.o OverSequenceForProp.o\
...
CFLAG = -I../ -I./src/sat/minisat/core -I./src/sat/minisat -I./src/model -I./src/check -I./src/sat/cadical/src -D__STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS -c -g -fpermissive -DNDEBUG -DQUIET -O3
