...
CPPSOURCES = src/model/CarSolver.cpp src/check/BackwardChecker.cpp src/check/ForwardChecker.cpp src/check/CleanCARCheckerF.cpp src/model/AigerModel.cpp src/model/MainSolver.cpp src/model/InvSolver.cpp src/model/State.cpp src/main.cpp src/model/OverSequence.cpp src/model/Log.cpp src/visualization/Vis.cpp src/model/OverSequenceForProp.cpp\
...
OBJS = CarSolver.o BackwardChecker.o ForwardChecker.o CleanCARCheckerF.o AigerModel.o State.o main.o aiger.o aigsim_for_vis.o MainSolver.o InvSolver.o OverSequence.o Log.o Vis.o OverSequenceForProp.o\
