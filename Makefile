...
OBJS = CarSolver.o CarSolver_cadical.o BackwardChecker.o ForwardChecker.o CleanCARCheckerF.o AigerModel.o State.o main.o aiger.o MainSolver.o InvSolver.o OverSequence.o Log.o OverSequenceForProp.o\
